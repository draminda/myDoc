...
@RestController
@RequestMapping("/api/my-doc-kafka")
public class MyDocKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MyDocKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MyDocKafkaResource(KafkaProperties kafkaProperties) {
